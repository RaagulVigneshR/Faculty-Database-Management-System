...
<head>
    ...
    <title>SRM FDMS Admin Dashboard</title>
...
?>
 ...
 <?php if($row->isPublic=='1'):?>                       
                        <p class="text-light">Your Profile is Public. Others can  see  your profile.</p>
 <?php else: ?>  
 <p class="text-light">Your Profile is not Public. Others can't see your profile.</p>  
 <?php endif;?>                   
<?php } ?>
