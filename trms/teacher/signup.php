...
<head>
    ...
    <title>SRM FDMS Admin Login</title>
...
<body class="bg-dark" style=" background-image: url('images/regback.jpg');">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h3 style="color:black">Faculty Record Management System  </h3>
                    <hr  color="red"/>
                     <h3 style="color:black"> Faculty Registration </h3>
                    <hr  color="red"/>
                </div>
