...
$reply=$dbh->prepare("update tblquery set reply=:reply where teacherId=:tid and id=:qid");
...
<head>
    ...
    <title>FDMS || Manage Queries</title>
...
<tr>
    <th>Reply</th>
    <td colspan="3"><textarea class="form-control" name="reply" required><?php  echo htmlentities($row->reply);?></textarea></td>
</tr>
<tr>
<th></th>
